...
import math
from .changes import filter_minimum_distances
...
class CMANet(Net):
    ...
    def forward(self, mode=None,
        ...
        if mode == 'language':
            ...
            obs_view12 = {}
            #torch.Size([12, 256, 256, 1])，clockwise
            ...
            # batch_x_norm.shape=torch.Size([1, 120, 12])
            ...
            candidate_lengths = np.array([len(angle_rad) + 1]).tolist()
